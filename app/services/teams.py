from .players import fetch_players_data, parse_players
...
def get_team_roster_stats(team_id):
    data = fetch_stats_api(f"/teams/{team_id}/roster")
    ...
    roster_stats = parse_players(fetch_players_data(roster_ids))
